...
LINKS = [
    ...
    ("user_related_to_metric_user_commit", "devops.user_related_to_devops.metric.user_commit", "user", "metric.user_commit", "related_to", 5),
    ("user_related_to_metric_user_project_participation", "devops.user_related_to_devops.metric.user_project_participation", "user", "metric.user_project_participation", "related_to", 5),
