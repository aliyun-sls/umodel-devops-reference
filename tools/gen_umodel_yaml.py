...
ENTITIES = {
    ...
    "pipeline": {
        ...
        "fields": [
            ...
            f("data_source", "string", "数据来源 github_actions/gitlab_ci/jenkins/yunxiao_flow", "Data source: github_actions/gitlab_ci/jenkins/yunxiao_flow"),
    ...
    "release": {
        ...
        "fields": [
            ...
            f("commit_sha", "string", "发布指向的提交SHA（tag 解析结果）", "Commit SHA the release points at (resolved from tag)", required=False),
